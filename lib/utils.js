...
exports.generateQueryStringItemLookup = function(query, credentials) {
  var condition = query.condition || 'All';
  var idType = query.idType || '';
  var responseGroup = (query.responseGroup || 'ItemAttributes').replace(/,/g, '%2C');
  var itemID = query.itemID || 'All';
  ...
  var unsignedString =
    ...
    "&Operation=ItemLookup&ResponseGroup=" + responseGroup +
    "&ItemID=" + itemID +
